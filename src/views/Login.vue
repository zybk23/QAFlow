    ...
    <div class="login-items-container">
      <div class="login-container-left-side">
        ...
        <Input
          ...
          title="Password"
        />
        <button v-on:click="handleSignIn" class="sign-in">Sign In</button>
      ...
      <div class="login-container-right-side">
        <h2 class="login-container-right-side-title">Welcome to login</h2>
        <h2 class="login-container-right-side-sub-title">
          Don't have an account
        </h2>
        <button
          v-on:click="handleOpenRegisterPage"
